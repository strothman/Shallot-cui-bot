...
| [`views/`](views/) | **Interactive UI & Views Package:** Modular package (`views/grid_views.py`, `views/blend_sdxl.py`, `views/blend_krea.py`, `views/pagination.py`, `views/modals.py`) creating all clickable buttons in Discord (U1–U4, V1–V4, `🛑 Cancel`, unified Blend Studio, pagination menus, and popup modals). |
